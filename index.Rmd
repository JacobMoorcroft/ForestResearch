...
InteractivePlot_public<-ggplotly(InteractivePlot_public, tooltip="text",width=800,height=600) %>%
...
InteractivePlot_private<-ggplotly(InteractivePlot_private, tooltip="text",width=800,height=600) %>%
  layout(margin = list(t = 50, r = 50, b = 50, l = 50))

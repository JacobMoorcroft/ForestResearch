...
Thank-you for taking the time to have a gander into this small project demonstrating a few of my skills in data management, organisation and visualisation. :) Although this project did not afford me an opportunity to show my skills in data collection, preparation, or advanced analysis, please do know that these are actually my forte! I just didn't want to use this data to support any misconceptions of country's environmental efforts, which could be brought about by erroneously performing analyses without accounting for *country size*, *available arable land*, or the *process of privatisation* (see [Data Availability Statement](https://github.com/JacobMoorcroft/ForestResearch/blob/main/data_availability_statement.txt)). I intend to do projects which include analysis in the future, which will become available on my [GitHub](https://github.com/JacobMoorcroft) as I start to work on them.
